...
| `dependencies` | Classic package versions (no modern package IDs) | e.g., `UiPath.System.Activities` ≤ 22.x |

**If `targetFramework` is `"Windows"` or `"Portable"`**, this is a modern project — use the `uipath-rpa-workflows` skill instead.
