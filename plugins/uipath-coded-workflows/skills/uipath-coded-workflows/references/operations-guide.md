...
Creates a complete UiPath coded automation project from scratch. **ALWAYS use `rpa-tool create-project`** — never write `project.json`, `project.uiproj`, or other scaffolding files manually.

### Steps

**1. Create the project with `rpa-tool create-project`:**
