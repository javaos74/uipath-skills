...
3. **Inspect the package** — run the inspect-package tool to get exact API signatures before writing code
...
- After identifying a package, run the inspect-package tool to discover exact APIs before coding
