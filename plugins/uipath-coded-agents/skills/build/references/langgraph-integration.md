...
> **CRITICAL: Never instantiate LLM clients at module level.** `uipath init` imports your file — module-level LLM clients will fail because auth may not have happened yet. Always create LLM instances inside graph nodes or functions.
